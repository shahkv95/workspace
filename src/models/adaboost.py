...
def fit_adaboost_model(
    ...
    """
    Fit Adaboost classifier on the training set, make predictions on the test set, and print evaluation metrics.
    ...
    try:
        ...
        logging.error("\nError occurred while fitting the Adaboost model.")
        logging.exception(e)
